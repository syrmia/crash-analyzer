...
public:
  ...
  llvm::Error run(StringRef InputFile,
                  ...
                  lldb::SBTarget &target, Triple TheTriple);
  ...
  MachineInstr *
  addInstr(MachineFunction *MF, MachineBasicBlock *MBB, MCInst &Inst,
           DebugLoc *Loc, bool IsCrashStart, RegSet &DefinedRegs,
           std::unordered_map<uint64_t, StringRef> &FuncStartSymbols,
  ...
  DecodeIntrsToMIR(Triple TheTriple, lldb::SBInstructionList &Instructions,
                   ...
                   lldb::SBTarget &target, bool HaveDebugInfo,
                   MachineFunction *MF, MachineBasicBlock *FirstMBB,
                   StringRef OriginalFunction, DISubprogram *DISP,
                   std::unordered_map<std::string, DISubprogram *> &SPs,
